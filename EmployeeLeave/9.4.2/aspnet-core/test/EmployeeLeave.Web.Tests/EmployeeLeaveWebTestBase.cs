...
using EmployeeLeave.Models.TokenAuth;
...
{
    public abstract class EmployeeLeaveWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmployeeLeaveWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmployeeLeaveWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmployeeLeaveDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmployeeLeaveDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmployeeLeaveDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmployeeLeaveDbContext, Task<T>> func)
        {
            T result;
