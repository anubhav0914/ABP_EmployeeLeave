...
namespace EmployeeLeave.Migrations
{
    ...
    [Migration("20250718103304_changingForigenKeyFouderTOUserINlEAVErEUES")]
    partial class changingForigenKeyFouderTOUserINlEAVErEUES
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeLeave.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeLeave.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EmployeeLeave.Employee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("Work_experince_year")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeLeave.LeaveRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("Founder_Id_approved_rejected_BY")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Founder_Id_approved_rejected_BY");
            ...
            modelBuilder.Entity("EmployeeLeave.Model.Manager", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EmployeeLeave.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("EmployeeLeave.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("EmployeeLeave.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EmployeeLeave.Authorization.Roles.Role", b =>
                {
                    b.HasOne("EmployeeLeave.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("EmployeeLeave.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("EmployeeLeave.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeLeave.LeaveRequest", b =>
                {
                    b.HasOne("EmployeeLeave.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeeLeave.Employee", null)
                    ...
                    b.HasOne("EmployeeLeave.LeaveType", "LeaveType")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EmployeeLeave.LeaveType", null)
                        .WithMany("LeaveRequests")
