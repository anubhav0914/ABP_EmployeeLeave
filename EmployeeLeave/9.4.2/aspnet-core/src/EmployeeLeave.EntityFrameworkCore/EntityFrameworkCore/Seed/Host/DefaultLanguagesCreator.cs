...
namespace EmployeeLeave.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = EmployeeLeaveConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EmployeeLeaveDbContext context)
        {
            _context = context;
        }
